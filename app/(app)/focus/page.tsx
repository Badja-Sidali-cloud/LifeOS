...
import { Plus, Minus, RotateCcw, Coffee, Maximize2, Minimize2 } from 'lucide-react';
    ...
    <div className="p-6 max-w-lg mx-auto">
      ...
      <Card className={`p-8 ${cardClass}`}>
        ...
        <div className="flex gap-4">
          ...
          <Button variant="outline" size="lg" onClick={() => setIsFullscreen((f) => !f)} title="Toggle fullscreen">
      ...
      {isFullscreen && (
        <div className="fixed inset-0 z-50 bg-background flex flex-col items-center justify-center">
          ...
          <p className="text-9xl font-mono font-bold text-foreground tabular-nums">
          ...
          <div className="flex gap-4 mt-10">
            ...
            <Button variant="outline" size="lg" onClick={() => { handleReset(); setIsFullscreen(false); }}>
              <RotateCcw className="w-4 h-4 mr-2" /> Reset
            </Button>
          </div>
          {timerMode === 'focus' && (
            <div className="mt-8 flex items-center gap-4">
              <p className="text-sm text-muted-foreground">Distractions: <span className="font-bold text-foreground">{distractionCount}</span></p>
              <Button size="sm" variant="outline" onClick={() => setDistractionCount((c) => c + 1)}>
                + Distraction
              </Button>
            </div>
          )}
